...
DirectionSpinner.prototype.eventListen = function(ball,directionSpinner, powerBar) {
  window.addEventListener("keyup", spinnerTurn);

  function spinnerTurn(e) {
    if (e.keyCode === 32) {
      directionTurn(ball,directionSpinner,powerBar);
    }
  }
  function directionTurn(ball,directionSpinner,powerBar) {
