...
function PlayHole(game, holeNumber) {
  ...
  this.strokes = 0;
  this.walls = [
    { x: 0, y: 0, width: 5, height: game.canvas.height },
    { x: game.canvas.width, y: 0, width: 5, height: game.canvas.height },
    { x: 0, y: 0, width: game.canvas.width, height: 5 },
    { x: 0, y: game.canvas.height, width: game.canvas.width, height: 5 } ];
