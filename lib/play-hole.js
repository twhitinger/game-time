...
function PlayHole(game, holeNumber) {
  ...
  this.strokes = 0;
  this.walls = [
      { x: -500, y: -20, width: 500, height: game.canvas.height + 20 },
      { x: game.canvas.width, y: 0, width: 500, height: game.canvas.height + 20 },
      { x: -20, y: -500, width: game.canvas.width + 20, height: 500 },
      { x: -20, y: game.canvas.height, width: game.canvas.width + 20, height: 500 }];
